...
@Component
@Slf4j
public class WandItemDataGenerator extends AbstractSpellItemDataGenerator {

    public WandItemDataGenerator(PathfinderDatabase database) {
        super(database);
    }

    @Override
    protected String itemName(Spell spell) {
        return "Wand of " + spell.name();
    }
