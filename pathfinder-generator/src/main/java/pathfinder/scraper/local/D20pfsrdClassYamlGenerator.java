...
@Service("d20pfsrd Class YAML Generator")
@Slf4j
@NotCached
public class D20pfsrdClassYamlGenerator extends AbstractD20pfsrdScraper implements LocalSourceDatabaseGenerator {
    ...
    public void generateLocalDatabase() {
        try {
            File file = new File("class_database.yml");
            file.delete();
