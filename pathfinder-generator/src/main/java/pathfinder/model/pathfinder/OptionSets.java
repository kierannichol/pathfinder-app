...
public class OptionSets {
    ...
    public static final OptionSetId ARMOR_ENHANCEMENT_BONUS = OptionSetId.of(Sources.CORE, "option_set:armor_enhancement");
    public static final OptionSetId LIGHT_ARMOR_MATERIAL = OptionSetId.of(Sources.CORE, "option_set:light_armor_material");
    public static final OptionSetId MEDIUM_ARMOR_MATERIAL = OptionSetId.of(Sources.CORE, "option_set:medium_armor_material");
    public static final OptionSetId HEAVY_ARMOR_MATERIAL = OptionSetId.of(Sources.CORE, "option_set:heavy_armor_material");
    ...
    public static final OptionSetId AMMUNITION_MATERIAL = OptionSetId.of(Sources.CORE, "option_set:ammunition_material");
