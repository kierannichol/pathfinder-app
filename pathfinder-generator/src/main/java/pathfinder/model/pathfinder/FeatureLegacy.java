...
@Builder
public record FeatureLegacy(Id id, String name, String label, String type, Description description, String prerequisites, String source) implements NamedEntity, FromSourceBook {
