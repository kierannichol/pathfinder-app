...
@Component("Prerequisite Parser V7")
@Lazy
@Slf4j
@RequiredArgsConstructor
public class PrerequisiteParserV7 {
...
//            .addReplacement("Skill Focus with the class skill of bloodline selected for this feat", "@feat:skill_focus#selected_bloodline_skill")
    ...
    public String prerequisites(Feature feature) {
        ...
        return extractPrerequisiteFormula(feature.prerequisites(), context);
    }
    ...
    public String prerequisites(Feat feat) {
        ...
        return extractPrerequisiteFormula(feat.prerequisites(), context);
    }

    private String extractPrerequisiteFormula(String prerequisites, PrerequisiteContext context) {
            ...
            if (context instanceof PrerequisiteContext c) {
                ...
                for (int i = 0; i < 4; i++) {
                    ...
                    var found = database.query(expandedQuery).findFirst()
                            .map(NamedEntity::id)
                            .map(PrerequisiteParserV7::formatId);
