...
export default function DataChoiceSelectButton({ choice, characterAtLevel, onSelect, label, buttonLabel, variant, dialogVariant, descriptionFn, search }: DataChoiceSelectButtonProps) {
