...
const RagePowerDatabase = createAbilityDatabaseSource("RagePowerDatabase", "ragepower");

export function useRagePowerDatabase() {
  return usePathfinderDatabase().ragePowerDatabase;
}

export default RagePowerDatabase;
