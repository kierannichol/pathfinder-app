...
const data = $root.data = (() => {
  ...
  data2.FeatureDbo = function() {
    function FeatureDbo2(properties) {
      this.tags = [];
      if (properties) {
        for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
          if (properties[keys[i]] != null)
    ...
    FeatureDbo2.prototype.id = "";
    FeatureDbo2.prototype.name = "";
    FeatureDbo2.prototype.tags = $util.emptyArray;
    FeatureDbo2.prototype.enabledFormula = "";
    FeatureDbo2.prototype.maxStacks = null;
    FeatureDbo2.prototype.label = null;
    FeatureDbo2.prototype.description = null;
    FeatureDbo2.prototype.stacks = null;
    let $oneOfFields;
    Object.defineProperty(FeatureDbo2.prototype, "_maxStacks", {
      get: $util.oneOfGetter($oneOfFields = ["maxStacks"]),
      set: $util.oneOfSetter($oneOfFields)
    });
    Object.defineProperty(FeatureDbo2.prototype, "_label", {
      get: $util.oneOfGetter($oneOfFields = ["label"]),
      set: $util.oneOfSetter($oneOfFields)
    });
    FeatureDbo2.create = function create(properties) {
      return new FeatureDbo2(properties);
    };
    FeatureDbo2.encode = function encode(message, writer) {
      if (!writer)
        writer = $Writer.create();
      if (message.id != null && Object.hasOwnProperty.call(message, "id"))
        writer.uint32(
    ...
    FeatureDbo2.encodeDelimited = function encodeDelimited(message, writer) {
      return this.encode(message, writer).ldelim();
    };
    FeatureDbo2.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
    ...
    FeatureDbo2.decodeDelimited = function decodeDelimited(reader) {
      if (!(reader instanceof $Reader))
        reader = new $Reader(reader);
      return this.decode(reader, reader.uint32());
    };
    FeatureDbo2.verify = function verify(message) {
      if (typeof message !== "object" || message === null)
        return "object expected";
      if (message.id != null && message.hasOwnProperty("id")) {
        if (!$util.isString(message.id))
    ...
    FeatureDbo2.fromObject = function fromObject(object) {
    ...
    FeatureDbo2.toObject = function toObject(message, options) {
      if (!options)
        options = {};
      let object = {};
      if (options.arrays || options.defaults)
    ...
    FeatureDbo2.prototype.toJSON = function toJSON() {
      return this.constructor.toObject(this, $protobuf__namespace.util.toJSONOptions);
    };
    FeatureDbo2.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
      if (typeUrlPrefix === void 0) {
        typeUrlPrefix = "type.googleapis.com";
      }
...
function read_proto(path2, decodeFn) {
  return new Promise((resolve, reject) => {
