...
import {ResolvedChoice, ResolvedMultiSelectChoice, ResolvedSelectChoice, ResolvedTextChoice} from "../Choice.ts";
...
export class ChoiceBridge {
  static from(data: ResolvedChoice): ChoiceModel {
    ...
    if (data instanceof ResolvedMultiSelectChoice) {
      return new MultiSelectChoiceBridge(data);
    }
...
export class MultiSelectChoiceBridge extends SelectChoiceModel {

  constructor(private readonly data: ResolvedMultiSelectChoice) {
    super();
  }
